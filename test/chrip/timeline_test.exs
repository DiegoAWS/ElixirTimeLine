defmodule Chrip.TimelineTest do
  ...
  describe "posts" do
    ...
    @valid_attrs %{body: "some body", likes_counter: 42, reposts_count: 42, username: "some username"}
    @update_attrs %{body: "some updated body", likes_counter: 43, reposts_count: 43, username: "some updated username"}
    @invalid_attrs %{body: nil, likes_counter: nil, reposts_count: nil, username: nil}
